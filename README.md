...
## Overview
This system uses **Markov Chains** to predict 3-digit lottery numbers[cite: 11, 12]. [cite_start]It processes 15+ years of data to identify the most probable numbers and transition states.
